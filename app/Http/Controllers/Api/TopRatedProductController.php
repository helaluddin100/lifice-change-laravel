...
class TopRatedProductController extends Controller
{
    public function store(Request $request)
    {
        ...
        TopRatedProduct::where('user_id', $request->user_id)
            ->where('shop_id', $request->shop_id)
            ->delete();

        // Add new selections
        foreach ($request->products as $productId) {
            TopRatedProduct::create([
    ...
    public function getSelectedProducts(Request $request)
    {
        ...
        $products = TopRatedProduct::where('user_id', $request->user_id)
            ->where('shop_id', $request->shop_id)
            ->get();
    ...
    public function delete(Request $request, $productId)
    {
        ...
        $product = TopRatedProduct::where('user_id', $request->user_id)
            ->where('shop_id', $request->shop_id)
