...
class FlashDealProductController extends Controller
{
    public function store(Request $request)
    {
        ...
        FlashDealProduct::where('user_id', $request->user_id)
    ...
    public function getSelectedProducts(Request $request)
    {
        ...
        $products = FlashDealProduct::where('user_id', $request->user_id)
            ->where('shop_id', $request->shop_id)
            ->get();
    ...
    public function delete(Request $request, $productId)
    {
        ...
        $product = FlashDealProduct::where('user_id', $request->user_id)
            ->where('shop_id', $request->shop_id)
