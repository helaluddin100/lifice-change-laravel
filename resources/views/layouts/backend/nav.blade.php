                                                ...
                                                <div class="notification">
                                                    <div class="notification-head">
                                                        ...
                                                        <div class="notification-icon">
                                                            <a href="#">
                                                                <span>
                                                                    <svg class="svg-two" width="20" height="20"
                                                    ...
                                                    <div class="notification-item-main">
                                                        <div class="notification-item">
                                                            <div class="notification-item-text">
                                                                <p> <span>James Eusobio </span> send a new payment for
                                                                    <span>
                                                                        SEO writing
                                                        ...
                                                        <div class="notification-btm-text">
                                                            <h2> <span class="">
                                                                    <svg width="24" height="24"
                                                                        ...
                                                                        xmlns="http://www.w3.org/2000/svg">
                                                                        <path d="M7 12L12 17L22 7M2 12L7 17M12 12L17 7"
                        ...
                        <div class="profile icon-dropdown" data-name="profile-drop">
                            ...
                            <ul class="profile-dropdown" id="profile-drop">
                                ...
                                <li>
                                    <a href="message.html">
                                        <span>
                                            <svg class="stroke-bgray-900 dark:stroke-gray-300" width="24"
                                                height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
